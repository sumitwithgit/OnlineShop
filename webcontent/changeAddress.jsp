    ...
    <ul class="navbar-nav mr-auto">
		...
		<div class="container mt-4">
			<div class="row">
				...
				<form action="changeAddress" method="post" enctype="multipart/form-data">
					<div class="card">
						...
						<div class="card-body">
								<div class="form-group">
									...
									<input type="text" placeholder="Enter Address" name="address" id="addresss" class="form-control"/>
								</div>
								<div class="form-group">
