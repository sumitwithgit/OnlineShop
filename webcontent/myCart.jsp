...
<nav class="navbar navbar-expand-lg navbar-dark primary-background">
  <a class="navbar-brand" href="userProfile.jsp"><i class="fa-solid fa-arrow-circle-left"></i> Back </a>
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      		<a class="navbar-brand ml-4" href="setting.jsp">Setting <i class="fa fa-cog"></i></a>
    </ul>
    	...
    	<%
    		...
    		{
    			%>
			    	<a href="payBill.jsp" class="btn btn-outline-light ml-2">Total Amount : <i class="fa fa-inr"></i> <%=totalAmount %> Order Now</a>
    			<%
    		}
    	%>
	...
	<h3 class="text-center">Products Available in MyCart</h3>
		<div class="row">
								...
								for(cart c:clist)
								{
									%>
										<tr>
											...
											<td><img src="cImg/<%=c.getProductPhoto() %>" width="100px" height="100px"/></td>
											<td><a href="incDecQuantity?quantity=minus&userId=<%=c.getUserId() %>&productId=<%=c.getProductId() %>" style="border-radius: 50%;" class="btn btn-outline-danger"><i class="fa fa-minus"></i></a> <%=c.getProductQuantity() %> <a href="incDecQuantity?quantity=plus&userId=<%=c.getUserId() %>&productId=<%=c.getProductId() %>" class="btn btn-outline-success" style="border-radius: 50%;"><i class="fa fa-plus"></i></a></td>
											<td><%=c.getProductPrice() %></td>
											<td><%=c.getTotalPrice() %></td>
											<td><a href="removeItemFromCart?itemNo=<%=c.getItemNo() %>" class="btn btn-danger">Remove <i class="fa fa-trash"></i></a></td>
										</tr>
									<%
								}
							%>
