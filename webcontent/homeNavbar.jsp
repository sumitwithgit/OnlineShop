...
<nav class="navbar navbar-expand-lg navbar-dark primary-background">
  <a class="navbar-brand" href="index.jsp">Online Shopping Shop <i class="fa-solid fa-truck-fast"></i></a>
    	...
    	<%
    		...
    		}else
    		{
    			if(user.getUserType().equals("normal"))
    			{
    				...
    				int quantity=cdao.getAllProductFormCartByUserId(user.getId());
    				%>
    					<a href="myCart.jsp" class="btn btn-outline-light ml-2"><i class="fa fa-cart-plus"></i> My Cart (<%=quantity %>)</a>
    				<%
    			}
    			%>
