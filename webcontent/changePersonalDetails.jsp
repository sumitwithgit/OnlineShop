    ...
    <ul class="navbar-nav mr-auto">
		...
		<h3>Edit Your Personal Details</h3>
			<div class="row">
				...
				<form action="editPersonalDetails" method="post" enctype="multipart/form-data">
					<div class="card">
						<div class="card-header text-center primary-background">
							<img alt="" src="img/<%=user.getProfile()%>" width="100px" height="100px" style="border-radius: 50%;">
							<h5><%=user.getName() %></h5>
						</div>
						<div class="card-body">
								<div class="form-group">
									...
									<input type="text" value="<%=user.getName() %>" placeholder="Enter New Name" name="name" id="name" class="form-control"/>
								</div>
								<div class="form-group">
									<label for="mobile">Enter Mobile</label>
									<input type="number" value="<%=user.getMobile() %>" placeholder="Enter New Mobile" name="mobile" id="mobile" class="form-control"/>
								</div>
								<div class="form-group">
									<label for="file">Select New Profile Pic</label>
