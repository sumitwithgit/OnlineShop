...
<head>
<meta charset="UTF-8">
<title>Order Received Page</title>
<link rel="stylesheet"
				...
				<table class="table table-striped">
					...
					<tbody>
							<%	orderDao odao=new orderDao(connectionProvider.getConnection());
								ArrayList<order> olist=odao.getAllOrders();
								int SNo=0;
								for(order o:olist)
								{
									%>
										<tr>
											...
											<td><a href="confirmOrder?orderId=<%=o.getOrderId()%>&orderStatus=accept" class="btn btn-success">Accept</a></td>
											<td><a href="confirmOrder?orderId=<%=o.getOrderId()%>&orderStatus=reject" class="btn btn-danger">Reject</a></td>
										</tr>
									<%
								}
							%>
